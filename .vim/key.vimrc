...
" =============================================================================
" Define some escape sequences for rxvt-unicode
" =============================================================================
...
map <Char-033><lt>M-Right>      <M-Right>
map <Char-033><lt>M-Left>       <M-Left>
map <Char-033><lt>M-Up>         <M-Up>
map <Char-033><lt>M-Down>       <M-Down>
...
" 020526 search the current word in all files in the working directory
  map g/ :silent Grep <C-R>/ <C-R>=expand("%:p:h")<CR>/*<CR><CR>
...
" nn  ,v :edit   <C-R>=vimrc<CR><CR>
  nn  ,vo :e   ~/.vim/option.vimrc<CR><CR>
  nn  ,vk :e   ~/.vim/key.vimrc<CR><CR>
